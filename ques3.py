...
class Ui_ques3(QtWidgets.QWidget):
    ...
    def retranslateUi(self, ques3):
        ...
        self.label.setText(_translate("ques3", "Question 3: How many chefs are in the world?"))
        self.R1.setText(_translate("ques3", "990,129 Chefs"))
        self.R2.setText(_translate("ques3", "9,224,191 Chefs"))
        self.R3.setText(_translate("ques3", "941,600 Chefs"))
        self.R4.setText(_translate("ques3", "748,293 Chefs"))
